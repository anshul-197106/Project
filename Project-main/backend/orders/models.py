...
class Order(models.Model):
    ...
    submission_file = models.FileField(upload_to='submissions/', blank=True, null=True, help_text='PDF file for delivery')
    github_link = models.URLField(max_length=500, blank=True, help_text='GitHub repository link for the project')
    submission_note = models.TextField(blank=True, help_text='Additional notes from the seller')
